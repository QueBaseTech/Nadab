...
import com.example.karokojnr.nadab_hotels.adapter.DashboardAdapter;
import com.example.karokojnr.nadab_hotels.model.Dashboard;
...
*/
    ...
    private void initializeDashboardItemList()
    {
        if(dashboardItemList == null)
        {
            ...
            dashboardItemList.add(new DashboardRecyclerViewItem ("Orders", R.drawable.make_order));
