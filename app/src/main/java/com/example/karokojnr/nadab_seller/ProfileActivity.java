...
import com.example.karokojnr.nadab_seller.fragments.ChangePasswordDialog;
...
public class ProfileActivity extends AppCompatActivity implements ChangePasswordDialog.Listener {
    ...
    private void handleResponse(Hotel hotel) {

        mProgressbar.setVisibility(View.GONE);
        mTvName.setText( hotel.getBusinessName ());
        mTvEmail.setText( hotel.getBusinessEmail ());
        mTvDate.setText( hotel.getCreated_at());
    }
